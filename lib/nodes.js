...
var Nodes = {
   ...
   * @returns {Function}
   */
  createClass : function( classDef, options ){
    ...
    var Nodes = function( data ){
      var constructor = function(){
          ...
          if( typeof this.factory !== 'function'){
            console.log( this.factory, classDef.$factory )
    ...
    Nodes.prototype = util.extend(
      ...
      util.zipObject(protoKeys, protoKeys.map(name=>classDef[name]))
    )
...
util.forEach( classActions, function( actionDef, actionName ){
  decorateWithAction.apply( null, [classPrototype, actionName].concat(actionDef) )
})
